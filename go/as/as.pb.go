...
const (
	HandleConnStateRequest_OFFLINE HandleConnStateRequest_State = 0
	HandleConnStateRequest_ONLINE  HandleConnStateRequest_State = 1
)
...
func (x HandleConnStateRequest_State) String() string {
	return proto.EnumName(HandleConnStateRequest_State_name, int32(x))
}

func (HandleConnStateRequest_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1d6d0f577a60e27d, []int{13, 0}
}
...
type HandleGatewayStatsRequest struct {
	...
	UpBytesCount int32 `protobuf:"varint,15,opt,name=up_bytes_count,json=upBytesCount,proto3" json:"up_bytes_count,omitempty"`
	// Downlink Packet bytes count
	DownBytesCount       int32    `protobuf:"varint,16,opt,name=down_bytes_count,json=downBytesCount,proto3" json:"down_bytes_count,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func init() {
	...
	proto.RegisterEnum("as.HandleConnStateRequest_State", HandleConnStateRequest_State_name, HandleConnStateRequest_State_value)
...
var fileDescriptor_1d6d0f577a60e27d = []byte{
	...
	,
}
