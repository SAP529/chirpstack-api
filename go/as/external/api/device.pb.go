...
type DeviceStats struct {
	...
	TxPacketsAck map[string]uint32 `protobuf:"bytes,8,rep,name=tx_packets_ack,json=txPacketsAck,proto3" json:"tx_packets_ack,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	// Uplink Estimated Signal Power.
	// Estimates the real received signal strength of a desired signal considering
	// the impact of background noise.
	RxEsp float32 `protobuf:"fixed32,9,opt,name=rx_esp,json=rxEsp,proto3" json:"rx_esp,omitempty"`
	// Uplink Payload Data from the device (KB).
	PayloadKb            uint32   `protobuf:"varint,10,opt,name=payload_kb,json=payloadKb,proto3" json:"payload_kb,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *DeviceStats) GetRxEsp() float32 {
	if m != nil {
		return m.RxEsp
	}
	return 0
...
func (m *DeviceStats) GetPayloadKb() uint32 {
	if m != nil {
		return m.PayloadKb
	}
	return 0
...
func (m *GetDeviceStatusRequest) Reset()         { *m = GetDeviceStatusRequest{} }
func (m *GetDeviceStatusRequest) String() string { return proto.CompactTextString(m) }
...
func (m *GetDeviceStatusRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetDeviceStatusRequest.Unmarshal(m, b)
}
func (m *GetDeviceStatusRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetDeviceStatusRequest.Marshal(b, m, deterministic)
}
func (m *GetDeviceStatusRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetDeviceStatusRequest.Merge(m, src)
}
func (m *GetDeviceStatusRequest) XXX_Size() int {
	return xxx_messageInfo_GetDeviceStatusRequest.Size(m)
}
func (m *GetDeviceStatusRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetDeviceStatusRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetDeviceStatusRequest proto.InternalMessageInfo

func (m *GetDeviceStatusRequest) GetDevEui() string {
	if m != nil {
		return m.DevEui
	}
	return ""
...
func (m *GetDeviceStatusResponse) Reset()         { *m = GetDeviceStatusResponse{} }
func (m *GetDeviceStatusResponse) String() string { return proto.CompactTextString(m) }
...
func (m *GetDeviceStatusResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetDeviceStatusResponse.Unmarshal(m, b)
}
func (m *GetDeviceStatusResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetDeviceStatusResponse.Marshal(b, m, deterministic)
}
func (m *GetDeviceStatusResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetDeviceStatusResponse.Merge(m, src)
}
func (m *GetDeviceStatusResponse) XXX_Size() int {
	return xxx_messageInfo_GetDeviceStatusResponse.Size(m)
}
func (m *GetDeviceStatusResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetDeviceStatusResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetDeviceStatusResponse proto.InternalMessageInfo

func (m *GetDeviceStatusResponse) GetDevEui() string {
	if m != nil {
		return m.DevEui
	}
	return ""
...
func (m *GetDeviceStatusResponse) GetStatus() string {
	if m != nil {
		return m.Status
	}
	return ""
...
func (m *GetDeviceDataRequest) Reset()         { *m = GetDeviceDataRequest{} }
func (m *GetDeviceDataRequest) String() string { return proto.CompactTextString(m) }
...
func (m *GetDeviceDataRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetDeviceDataRequest.Unmarshal(m, b)
}
func (m *GetDeviceDataRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetDeviceDataRequest.Marshal(b, m, deterministic)
}
func (m *GetDeviceDataRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetDeviceDataRequest.Merge(m, src)
}
func (m *GetDeviceDataRequest) XXX_Size() int {
	return xxx_messageInfo_GetDeviceDataRequest.Size(m)
}
func (m *GetDeviceDataRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetDeviceDataRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetDeviceDataRequest proto.InternalMessageInfo

func (m *GetDeviceDataRequest) GetDevEui() string {
	if m != nil {
		return m.DevEui
	}
	return ""
...
func (m *GetDeviceDataRequest) GetLimit() int64 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *GetDeviceDataRequest) GetOffset() int64 {
	if m != nil {
		return m.Offset
	}
	return 0
...
type GetDeviceDataResponse struct {
	// Total number of devices available within the result-set.
	TotalCount int64 `protobuf:"varint,1,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"`
	// Devices uplink events within this result-set.
	Result               []*DeviceEventsListItem `protobuf:"bytes,2,rep,name=result,proto3" json:"result,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}

func (m *GetDeviceDataResponse) Reset()         { *m = GetDeviceDataResponse{} }
func (m *GetDeviceDataResponse) String() string { return proto.CompactTextString(m) }
...
func (m *GetDeviceDataResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetDeviceDataResponse.Unmarshal(m, b)
}
func (m *GetDeviceDataResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetDeviceDataResponse.Marshal(b, m, deterministic)
}
func (m *GetDeviceDataResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetDeviceDataResponse.Merge(m, src)
}
func (m *GetDeviceDataResponse) XXX_Size() int {
	return xxx_messageInfo_GetDeviceDataResponse.Size(m)
}
func (m *GetDeviceDataResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetDeviceDataResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetDeviceDataResponse proto.InternalMessageInfo

func (m *GetDeviceDataResponse) GetTotalCount() int64 {
	if m != nil {
		return m.TotalCount
	}
	return 0
...
func (m *GetDeviceDataResponse) GetResult() []*DeviceEventsListItem {
	if m != nil {
		return m.Result
	}
	return nil
...
type DeviceEventsListItem struct {
	// DevEUI EUI (8 bytes).
	DevEui string `protobuf:"bytes,1,opt,name=dev_eui,json=devEUI,proto3" json:"dev_eui,omitempty"`
	// Name of the device (must be unique).
	...
	// TX frequency (in Hz).
	Frequency uint32 `protobuf:"varint,8,opt,name=frequency,proto3" json:"frequency,omitempty"`
	// FSK datarate (bits / sec).
	Datarate uint32 `protobuf:"varint,9,opt,name=datarate,proto3" json:"datarate,omitempty"`
...
func (m *DeviceEventsListItem) Reset()         { *m = DeviceEventsListItem{} }
func (m *DeviceEventsListItem) String() string { return proto.CompactTextString(m) }
func (*DeviceEventsListItem) ProtoMessage()    {}
func (*DeviceEventsListItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_57ec3c2ed36f7cf9, []int{35}
}

func (m *DeviceEventsListItem) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DeviceEventsListItem.Unmarshal(m, b)
}
func (m *DeviceEventsListItem) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DeviceEventsListItem.Marshal(b, m, deterministic)
}
func (m *DeviceEventsListItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeviceEventsListItem.Merge(m, src)
}
func (m *DeviceEventsListItem) XXX_Size() int {
	return xxx_messageInfo_DeviceEventsListItem.Size(m)
}
func (m *DeviceEventsListItem) XXX_DiscardUnknown() {
	xxx_messageInfo_DeviceEventsListItem.DiscardUnknown(m)
}

var xxx_messageInfo_DeviceEventsListItem proto.InternalMessageInfo

func (m *DeviceEventsListItem) GetDevEui() string {
	if m != nil {
		return m.DevEui
	}
	return ""
...
func (m *DeviceEventsListItem) GetDeviceName() string {
	if m != nil {
		return m.DeviceName
	}
	return ""
...
func (m *DeviceEventsListItem) GetLastSeenAt() *timestamp.Timestamp {
	if m != nil {
		return m.LastSeenAt
	}
	return nil
...
func (m *DeviceEventsListItem) GetFCnt() uint32 {
	if m != nil {
		return m.FCnt
	}
	return 0
...
func (m *DeviceEventsListItem) GetRssi() int32 {
	if m != nil {
		return m.Rssi
	}
	return 0
...
func (m *DeviceEventsListItem) GetLoraSnr() float64 {
	if m != nil {
		return m.LoraSnr
	}
	return 0
...
func (m *DeviceEventsListItem) GetGatewayId() string {
	if m != nil {
		return m.GatewayId
	}
	return ""
...
func (m *DeviceEventsListItem) GetFrequency() uint32 {
	if m != nil {
		return m.Frequency
	}
	return 0
...
func (m *DeviceEventsListItem) GetDatarate() uint32 {
	if m != nil {
		return m.Datarate
	}
	return 0
...
func (m *DeviceEventsListItem) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *DeviceEventsListItem) GetConfirmedUplink() bool {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*GetDeviceStatusRequest)(nil), "api.GetDeviceStatusRequest")
	proto.RegisterType((*GetDeviceStatusResponse)(nil), "api.GetDeviceStatusResponse")
	proto.RegisterType((*PacketSuccess)(nil), "api.PacketSuccess")
	proto.RegisterType((*GetDeviceDataRequest)(nil), "api.GetDeviceDataRequest")
	proto.RegisterType((*GetDeviceDataResponse)(nil), "api.GetDeviceDataResponse")
	proto.RegisterType((*DeviceEventsListItem)(nil), "api.DeviceEventsListItem")
}
...
var fileDescriptor_57ec3c2ed36f7cf9 = []byte{
	...
	,
}
...
type DeviceServiceClient interface {
	...
	GetStatus(ctx context.Context, in *GetDeviceStatusRequest, opts ...grpc.CallOption) (*GetDeviceStatusResponse, error)
...
func (c *deviceServiceClient) GetStatus(ctx context.Context, in *GetDeviceStatusRequest, opts ...grpc.CallOption) (*GetDeviceStatusResponse, error) {
	out := new(GetDeviceStatusResponse)
	err := c.cc.Invoke(ctx, "/api.DeviceService/GetStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deviceServiceClient) GetDeviceData(ctx context.Context, in *GetDeviceDataRequest, opts ...grpc.CallOption) (*GetDeviceDataResponse, error) {
	out := new(GetDeviceDataResponse)
	err := c.cc.Invoke(ctx, "/api.DeviceService/GetDeviceData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeviceServiceServer interface {
	...
	// Get returns the device status matching the given DevEUI.
	GetStatus(context.Context, *GetDeviceStatusRequest) (*GetDeviceStatusResponse, error)
	// GetDeviceData returns the device uplink data matching the given DevEUI.
...
func (*UnimplementedDeviceServiceServer) GetStatus(ctx context.Context, req *GetDeviceStatusRequest) (*GetDeviceStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStatus not implemented")
}
func (*UnimplementedDeviceServiceServer) GetDeviceData(ctx context.Context, req *GetDeviceDataRequest) (*GetDeviceDataResponse, error) {
...
func _DeviceService_GetStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.DeviceService/GetStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).GetStatus(ctx, req.(*GetDeviceStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DeviceService_GetDeviceData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDeviceDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).GetDeviceData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.DeviceService/GetDeviceData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).GetDeviceData(ctx, req.(*GetDeviceDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DeviceService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DeviceService_GetDeviceData_Handler,
		},
	},
