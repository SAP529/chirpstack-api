...
goog.exportSymbol('proto.as.HandleConnStateRequest', null, global);
goog.exportSymbol('proto.as.HandleConnStateRequest.State', null, global);
 ...
 * @constructor
 */
proto.as.HandleConnStateRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.as.HandleConnStateRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.as.HandleConnStateRequest.displayName = 'proto.as.HandleConnStateRequest';
}
 ...
 * @return {!Object}
 */
proto.as.HandleConnStateRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.as.HandleConnStateRequest.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.as.HandleConnStateRequest} msg The msg instance to transform.
 * @return {!Object}
 */
proto.as.HandleConnStateRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    gatewayId: msg.getGatewayId_asB64(),
    state: msg.getState(),
    statsId: msg.getStatsId_asB64(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.as.HandleConnStateRequest}
 */
proto.as.HandleConnStateRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.as.HandleConnStateRequest;
  return proto.as.HandleConnStateRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.as.HandleConnStateRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.as.HandleConnStateRequest}
 */
proto.as.HandleConnStateRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.as.HandleConnStateRequest} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.as.HandleConnStateRequest.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.as.HandleConnStateRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.as.HandleConnStateRequest.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getGatewayId_asU8();
  if (f.length > 0) {
    writer.writeBytes(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.as.HandleConnStateRequest} The clone.
 */
proto.as.HandleConnStateRequest.prototype.cloneMessage = function() {
  return /** @type {!proto.as.HandleConnStateRequest} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.as.HandleConnStateRequest.prototype.getGatewayId = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldProto3(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.as.HandleConnStateRequest.prototype.getGatewayId_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getGatewayId()));
};
 ...
 * @return {!Uint8Array}
 */
proto.as.HandleConnStateRequest.prototype.getGatewayId_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getGatewayId()));
};
...
/** @param {!(string|Uint8Array)} value  */
proto.as.HandleConnStateRequest.prototype.setGatewayId = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 */
proto.as.HandleConnStateRequest.prototype.getState = function() {
  return /** @type {!proto.gw.State} */ (jspb.Message.getFieldProto3(this, 2, 0));
};


/** @param {!proto.gw.State} value  */
proto.as.HandleConnStateRequest.prototype.setState = function(value) {
  jspb.Message.setField(this, 2, value);
};


/**
 * optional bytes stats_id = 3;
 * @return {!(string|Uint8Array)}
 */
proto.as.HandleConnStateRequest.prototype.getStatsId = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldProto3(this, 3, ""));
};
 ...
 * @return {string}
 */
proto.as.HandleConnStateRequest.prototype.getStatsId_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getStatsId()));
};
 ...
 * @return {!Uint8Array}
 */
proto.as.HandleConnStateRequest.prototype.getStatsId_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getStatsId()));
};
 ...
 * @enum {number}
 */
proto.as.HandleConnStateRequest.State = {
  OFFLINE: 0,
  ONLINE: 1
};
