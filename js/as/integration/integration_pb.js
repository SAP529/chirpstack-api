...
goog.exportSymbol('proto.integration.GatewayConnStatEvent', null, global);
 ...
 * @constructor
 */
proto.integration.GatewayConnStatEvent = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.integration.GatewayConnStatEvent, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.integration.GatewayConnStatEvent.displayName = 'proto.integration.GatewayConnStatEvent';
}
 ...
 * @return {!Object}
 */
proto.integration.GatewayConnStatEvent.prototype.toObject = function(opt_includeInstance) {
  return proto.integration.GatewayConnStatEvent.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.integration.GatewayConnStatEvent} msg The msg instance to transform.
 * @return {!Object}
 */
proto.integration.GatewayConnStatEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    gatewayId: msg.getGatewayId_asB64(),
    state: msg.getState(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.integration.GatewayConnStatEvent}
 */
proto.integration.GatewayConnStatEvent.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.integration.GatewayConnStatEvent;
  return proto.integration.GatewayConnStatEvent.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.integration.GatewayConnStatEvent} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.integration.GatewayConnStatEvent}
 */
proto.integration.GatewayConnStatEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * Class method variant: serializes the given message to binary data
 * (in protobuf wire format), writing to the given BinaryWriter.
 * @param {!proto.integration.GatewayConnStatEvent} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.integration.GatewayConnStatEvent.serializeBinaryToWriter = function(message, writer) {
  message.serializeBinaryToWriter(writer);
};
 ...
 * @return {!Uint8Array}
 */
proto.integration.GatewayConnStatEvent.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  this.serializeBinaryToWriter(writer);
  return writer.getResultBuffer();
};
 ...
 * @param {!jspb.BinaryWriter} writer
 */
proto.integration.GatewayConnStatEvent.prototype.serializeBinaryToWriter = function (writer) {
  var f = undefined;
  f = this.getGatewayId_asU8();
  if (f.length > 0) {
    writer.writeBytes(
...
/**
 * Creates a deep clone of this proto. No data is shared with the original.
 * @return {!proto.integration.GatewayConnStatEvent} The clone.
 */
proto.integration.GatewayConnStatEvent.prototype.cloneMessage = function() {
  return /** @type {!proto.integration.GatewayConnStatEvent} */ (jspb.Message.cloneMessage(this));
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.integration.GatewayConnStatEvent.prototype.getGatewayId = function() {
 ...
 * @return {string}
 */
proto.integration.GatewayConnStatEvent.prototype.getGatewayId_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getGatewayId()));
};
 ...
 * @return {!Uint8Array}
 */
proto.integration.GatewayConnStatEvent.prototype.getGatewayId_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getGatewayId()));
};
...
/** @param {!(string|Uint8Array)} value  */
proto.integration.GatewayConnStatEvent.prototype.setGatewayId = function(value) {
  jspb.Message.setField(this, 1, value);
};


/**
 * optional gw.State state = 2;
 * @return {!proto.gw.State}
 */
proto.integration.GatewayConnStatEvent.prototype.getState = function() {
  return /** @type {!proto.gw.State} */ (jspb.Message.getFieldProto3(this, 2, 0));
};


/** @param {!proto.gw.State} value  */
proto.integration.GatewayConnStatEvent.prototype.setState = function(value) {
  jspb.Message.setField(this, 2, value);
};
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.integration.GatewayConnStatEvent.prototype.getMetaDataMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.integration.GatewayConnStatEvent.prototype.getTagsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
